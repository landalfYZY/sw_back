      ...
      <Row :gutter="16">
        ...
        <div class="panel-center item-center">
          <div style="text-align:Center">
            <div>
              <Icon type="university" size="30" color="#66CC99"></Icon>
            </div>
            <div>学校</div>
          </div>
        ...
        <div class="panel-center item-center">
          <div style="text-align:Center">
            <div>
              <Icon type="ios-bookmarks" color="#0099ff" size="30"></Icon>
            </div>
            <div>缴费项</div>
          </div>
        ...
        <div class="panel-center item-center">
          <div style="text-align:Center">
            <div>
              <Icon type="filing" color="#0099ff" size="30"></Icon>
            </div>
            <div>缴费人数</div>
          </div>
        ...
        <div class="panel-center item-center">
          <div style="text-align:Center">
            <div>
              <Icon type="social-yen" color="#FF6633" size="30"></Icon>
            </div>
            <div>缴费金额</div>
          </div>
          <div style="height:60px">

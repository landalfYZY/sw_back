    ...
    <div>
              <div class="panel-between">
                <div class="panel-start">
                  ...
                  <button class="ui-btn ui-btn-default" @click="navTo('/wiseMealRecharge')"><Icon type="plus-round" color="#00CC66"></Icon>&nbsp;&nbsp;添加充值项</button>
                </div>
                <div class="panel-end">
              ...
              <el-table style="margin-top:15px;width: 100%" :data="pubList" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="charge" label="充值金额" > </el-table-column>
                  ...
                  <template slot-scope="scope">
                    <el-dropdown size="mini" split-button type="default" trigger="click">
                      ...
                      <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item><div style="width:100px;text-align:Center" @click="addToTui(scope.row.sunwouId)">删除</div></el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
                  </template>
                </el-table-column>
  ...
  methods: {
    ...
    pubSearch() {
      ...
      for (var i in this.pubQuery.wheres) {
        if (this.pubQuery.wheres[i].value == "charge") {
          temp = i;
        }
      }
      if (temp == -1) {
    ...
    getPubList() {
      ...
      var that = this;
      $.ajax({
        url: sessionStorage.getItem("API") + "charge/find",
        type: "POST",
        data: {
